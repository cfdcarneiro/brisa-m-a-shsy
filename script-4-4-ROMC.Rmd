...
Exact p value: `r meta_differentiationYN$pval`
Exact Q test p value `r meta_differentiationYN$QEp`

intercept
Effect (% of control): `r exp(meta_differentiationYN$b[1])`
CI.lb (%): `r exp(meta_differentiationYN$ci.lb[1])`
CI.ub (%): `r exp(meta_differentiationYN$ci.ub[1])`
moderator:
Effect (% of control): `r exp(meta_differentiationYN$b[2])`
CI.lb (%): `r exp(meta_differentiationYN$ci.lb[2])`
CI.ub (%): `r exp(meta_differentiationYN$ci.ub[2])`
...
Exact Q test p value `r meta_difduration$QEp`
...
Exact Q test p value `r meta_aggregation$QEp`
...
Exact Q test p value `r meta_concent$QEp`
...
Exact Q test p value `r meta_duration$QEp`
...
Exact Q test p value `r meta_assay$QEp`
...
Exact Q test p value `r meta_density$QEp`
...
```{r}
dat = dados_uteis
meus_preditores = c("Diferentiation_method", "Abeta_aggregation", "Assay", "Concentration_uM", "Cell_density")
...
melhor_modelo.summary[3,4] = anova(multi_meta_reg@objects[[1]], btt = 4)$QMp
melhor_modelo.summary[4,4] = anova(multi_meta_reg@objects[[1]], btt = 5)$QMp
```
